# Azure AI Foundry Agent Service: Standard Agent Setup with Existing Account
...
* An existing Azure AI Foundry account (`Microsoft.CognitiveServices/accounts`) with system-assigned managed identity enabled.
* An existing project under that account that you want to configure for agents.
* The full resource ID of the Azure AI Foundry account (for example `/subscriptions/<subscription-id>/resourceGroups/<resource-group-name>/providers/Microsoft.CognitiveServices/accounts/<account-name>`).
* The name of the existing project that should be wired up with dependencies and capability hosts.
* (Optional) Existing Azure AI Search, Azure Storage, or Azure Cosmos DB accounts to reuse. Leave the related parameters empty to create new resources.

## Steps

[![Deploy To Azure](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/deploytoazure.svg?sanitize=true)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fazure-ai-foundry%2Ffoundry-samples%2Frefs%2Fheads%2Fmain%2Fsamples%2Fmicrosoft%2Finfrastructure-setup%2F41.1-standard-agent-setup%2Fazuredeploy.json)
...
```bash
    az deployment group create --resource-group <new-rg-name> --template-file main.bicep \
      --parameters aiServicesResourceId="/subscriptions/<subscription-id>/resourceGroups/<resource-group-name>/providers/Microsoft.CognitiveServices/accounts/<account-name>" \
