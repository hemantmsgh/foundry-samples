// Standard agent setup using an existing Azure AI Foundry account and project
...
@description('Region for new dependent resources such as Azure AI Search, Storage, and Cosmos DB.')
param location string = 'eastus'

@description('Resource ID of the existing Azure AI Foundry account to reuse.')
param aiServicesResourceId string

@description('Name of the existing project under the Azure AI Foundry account to configure.')
...
var accountParts = split(aiServicesResourceId, '/')
...
/*
  Ensure the specified AI Services account hosts the requested model deployment
*/
...
/*
  Reuses the existing project (sub-resource of the AI Services account) and wires required connections
*/
